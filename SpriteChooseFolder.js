...
SpriteChooseFolder.prototype.selectFolder = function(index) {
    let gameCardCollection = $gameCardPlayer.getGameCardCollection(index);
    let gameBattleCollection = CardBattleManager.createGameBattleCollection(gameCardCollection);

    CardBattleManager.setPlayerBattleCollection(gameBattleCollection);
    this.closeWindows();
    this.disable();
};
